...
const Arch = (props: Props) => {
  return (
    <section className='photosnap-content'>
        <div className='container-content'>
            <div className='imgtopArch'>
            </div>
            <div className='container-info'>
                <div className='title'>
                    ...
                    <span>HTML / CSS / Javascrit / React / Styled-components</span>
                    <a href={'https://magical-daffodil-dbe1bc.netlify.app'}><button>Acessar o site</button></a>
                </div>
                <div className='images'>
                    ...
                    <h2>Imagens</h2>
                    <div className='bgCapaArch'></div>
                    <div className='bgMobileArch'></div>
                </div>
            </div>
            <div className='container-previus-next'>
                <div className='previous'>
                    <h2>Photosnap</h2>
                    <Link to={'/photosnap'}><button><img alt='Projeto Anterior' src={arrowleft} />Projeto anterior</button></Link>
                </div>
                <div className='next'>
                    <h2>Designo</h2>
                    <Link to={'/designo'}><button>Projeto seguinte<img alt='Projeto Seguinte' src={arrowright} /></button></Link>
                </div>
            </div>
        </div>
    </section>
