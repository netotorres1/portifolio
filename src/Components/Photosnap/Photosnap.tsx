...
const Photosnap = (props: Props) => {
  return (
    <section className='photosnap-content'>
        <div className='container-content'>
            <div className='imgtopPhotosnap'>
            </div>
            <div className='container-info'>
                <div className='title'>
                    ...
                    <a href={'https://dashing-centaur-6af6b3.netlify.app'}><button>Acessar o site</button></a>
                </div>
                <div className='images'>
                    ...
                    <h2>Imagens</h2>
                    <div className='bgCapaPhotosnap'></div>
                    <div className='bgMobilePhotosnap'></div>
                </div>
            </div>
            <div className='container-previus-next'>
                <div className='previous'>
                    <h2>...</h2>
                    <button><img alt='Anterior' src={arrowleft} />Projeto anterior</button>
                </div>
                <div className='next'>
                    <h2>Arch</h2>
                    <Link to={'/arch'}><button>Projeto seguinte<img alt='Seguinte' src={arrowright} /></button></Link>
                </div>
            </div>
        </div>
    </section>
